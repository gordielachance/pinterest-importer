...
= 0.4.3 =
* new function Pinim_Raw_Pin_Item::get_post_content()
* renamed Pinim_Raw_Pin_Item::build_post_content() to Pinim_Raw_Pin_Item::append_medias()
...
* removed functions get_blank_post() and get_post_status(), which have been merged with Pinim_Raw_Pin_Item::save()
